...
#define ENCODER_PHASE_A            &MODULE_P00,9
#define ENCODER_PHASE_B            &MODULE_P00,10
...
void SCUERU_Int0_Handler(void)
{
    count++;
        ...
        if(IfxPort_getPinState(ENCODER_PHASE_B) == 1 && IfxPort_getPinState(ENCODER_PHASE_A) == 1)        encoder_mode = 0;
        else if(IfxPort_getPinState(ENCODER_PHASE_B) == 1 && IfxPort_getPinState(ENCODER_PHASE_A) == 0)   encoder_mode = 1;

        if(encoder_mode == 1)
        {
            if((IfxPort_getPinState(ENCODER_PHASE_B) == 0))   encoder++;
        }
...
void initPeripheralsAndERU(void)
{
    ...
    IfxPort_setPinMode(ENCODER_PHASE_A, IfxPort_Mode_inputPullUp);
    IfxPort_setPinMode(ENCODER_PHASE_B, IfxPort_Mode_inputPullUp);
