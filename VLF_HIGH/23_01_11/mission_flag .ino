...
{
  if(F_Sonar_Distance <=550)
  {
    motor_control_l(1,20,20);
    delay(800);
  }
}
...
void loop() {
      ...
      switch(mission_flag)
      {
        case 1:line_tracing();break;
        case 2:wall_follow();wall_following_CW();break;
        case 3:line_tracing();break;
        case 4:wall_following_CW();break;
      }
      if(index==-5555)
      {
        wall_follow();wall_following_CW();
      }
